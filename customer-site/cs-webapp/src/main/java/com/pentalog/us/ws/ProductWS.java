...
public class ProductWS {
    ...
    public ProductDescription getProductDescriptionByProductId(Product product) {
        return productDescriptionService
                .getProductDescriptionByProductId(product);
    }

    @GET
    @Path("/descriptions/product/{id}")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public ProductDescription ggetProductDescriptionByProductId(
            @PathParam("id") int id) {
        return productDescriptionService
                .getProductDescriptionByProductId(productService
                        .getProductById(id));
    }
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public Map<String, List<ProductFeature>> getProductFeaturesByProductId(
            Product product) {
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public ProductImagery getProductImageryByProductId(@PathParam("id") int id) {
        return productImageryService.getProductImageryByProductId(productService.getProductById(id));
    }
    /**
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public ProductPresentation getProductPresentationById(
            @PathParam("id") int id) {
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public List<ProductPresentation> getProductPresentationByProductId(
            Product product) {
        return productPresentationService
                .getProductPresentationByProductId(product);
    }

    @GET
    @Path("/presentations/product/{id}")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public List<ProductPresentation> ggetProductPresentationByProductId(
            @PathParam("id") int id) {
        return productPresentationService
                .getProductPresentationByProductId(productService.getProductById(id));
    }
    ...
    @Path("/presentations")
    @Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    public void deleteProductPresentation(
            ProductPresentation productPresentation) {
        productPresentationService
                .deleteProductPresentation(productPresentation);
    }
